...
import { getLeadById, updateLead } from "@/app/lib/server/leadStore"
...
export async function PATCH(req: NextRequest, { params }: Params) {
  ...
  const { id: _id, created_at: _ca, created_by: _cb, ...safePatch } = body as Partial<Lead> & { id?: string; created_at?: string; created_by?: string }

  const updated = updateLead(id, safePatch)
